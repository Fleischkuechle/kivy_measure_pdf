...
class PDFViewer(BoxLayout):
    def __init__(self, pdf_path, **kwargs):
        ...
        self.layout_box = GridLayout(cols=1, size_hint_y=None)
        self.layout_box.bind(minimum_height=self.layout_box.setter("height"))

        # self.layout_box: BoxLayout = BoxLayout()
        # self.layout_box.orientation = "vertical"
        # self.layout_box.padding = 5
        self.scroll_view.add_widget(self.layout_box)
        self.pdf_document = fitz.open(pdf_path)
        self.current_page: int = 0
        self.image_widget: Image = Image()
        self.layout_box.add_widget(self.image_widget)
